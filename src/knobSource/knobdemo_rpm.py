...
class Frame(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.Frame.__init__(self, None, -1, "RPM meter Demo", size=(500, 500))
        path = os.path.dirname(os.path.realpath(__file__))
        sizer = wx.BoxSizer(wx.VERTICAL)
        self.ctrl = knob.KnobCtrl(self, value=10000, minValue=0, maxValue=14000, increment=100, size=(150, 150))
        self.ctrl.ShowToolTip = False
        self.ctrl.ShowPointer = True
        self.ctrl.ShowValue = True
        self.ctrl.GaugeText = 'RPM\n\n'
        self.ctrl.GaugeImage = wx.Image(path+'/images/rpm.png')
        self.ctrl.ShowScale = True
        self.ctrl.SetThumbSize(10)
        self.ctrl.SetTickFrequency(500)
        self.ctrl.SetTickColours([(0, 255, 0, 255), (255, 187, 0, 255), (255, 61, 0, 255)])
        self.ctrl.SetTickColourRanges([75, 90, 100])
        ...
        self.ctrl.OdometerToolTip = "Counter is accumulated revolutions"
